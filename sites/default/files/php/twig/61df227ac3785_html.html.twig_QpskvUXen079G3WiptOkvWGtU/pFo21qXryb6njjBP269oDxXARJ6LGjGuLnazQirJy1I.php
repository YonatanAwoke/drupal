...
class __TwigTemplate_3cf52a66133740a2f60d2767ba6c78225581f62b4789c466e9bcc1b65fa972eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<a href=\"#\" class=\"back-to-top\"><img alt=\"Back to Top\" src=\"";
        // line 23
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, call_user_func_array($this->env->getFunction('file_url')->getCallable(), [($this->sandbox->ensureToStringAllowed(($context["theme_path"] ?? null), 23, $this->source) . "/images/gototop.png")]), "html", null, true);
        echo "\"/></a>
</div>
...
";
    ...
    {
        return new Source("", "themes/theme__100200/templates/html.html.twig", "C:\\xampp\\htdocs\\drupal\\themes\\theme__100200\\templates\\html.html.twig");
    }
